 ...
 * Time: 12:51 PM
 */
class PayamakariaGateway extends GatewayAbstract {
	...
	public function __construct() {
		...
		$this->webService  = config('sms.gateway.payamakaria.webService');
		$this->username    = config('sms.gateway.payamakaria.username');
		$this->password    = config('sms.gateway.payamakaria.password');
		$this->from        = config('sms.gateway.payamakaria.from');
	}
